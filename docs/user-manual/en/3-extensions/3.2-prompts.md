...
StackFerry provides a smart backfill protection mechanism to ensure your manual modifications are not lost.
...
```
stackferry://import/prompt?data=<base64-encoded preset>
```
