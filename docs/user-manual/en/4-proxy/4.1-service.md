...
sequenceDiagram
    ...
    participant Proxy as Local Proxy (StackFerry)
...
After starting the proxy and enabling app takeover, StackFerry modifies app configurations:
...
When stopping the proxy, StackFerry will:
