...
| File | Description |
|------|-------------|
| [5.1-config-files.md](./5-faq/5.1-config-files.md) | StackFerry storage, CLI configuration file formats |
...
- Applicable to StackFerry v3.16.0+
...
- [GitHub Issues](https://github.com/Ninthless/StackFerry/issues)
- [GitHub Repository](https://github.com/Ninthless/StackFerry)
