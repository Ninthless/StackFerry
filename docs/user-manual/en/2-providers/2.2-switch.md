...
2. StackFerry updates the configuration file
...
1. Right-click the StackFerry icon in the system tray
...
When switching providers, StackFerry modifies the following files:
