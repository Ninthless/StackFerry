...
StackFerry は `stackferry://` ディープリンクプロトコルをサポートしており、リンクからワンクリックで設定をインポートできます。
...
StackFerry はオンラインのディープリンク生成ツールを提供しています：
...
StackFerry 公式のオンラインディープリンク生成ツールを使用するとより便利です。
...
1. システムが StackFerry を開くかどうかを確認
2. 確認後、StackFerry が起動
3. インポート確認ダイアログを表示
4. インポートを確認
...
StackFerry のインストール時に `stackferry://` プロトコルが自動登録されます。
