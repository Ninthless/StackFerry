...
import { CcSwitchImportDialog } from "@/components/providers/CcSwitchImportDialog";
import type { CcSwitchImportPreview } from "@/lib/api/providers";
...
describe("CcSwitchImportDialog", () => {
  ...
  it("defaults to the current agent and can switch to all agents", async () => {
    ...
    await user.click(screen.getByRole("tab", { name: "provider.ccSwitchImport.allAgents" }));
