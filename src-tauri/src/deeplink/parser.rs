...
//!
//! Parses stackferry:// URLs into DeepLinkImportRequest structures.
...
/// Parse a stackferry:// URL into a DeepLinkImportRequest
///
/// Expected format:
/// stackferry://v1/import?resource={type}&...
pub fn parse_deeplink_url(url_str: &str) -> Result<DeepLinkImportRequest, AppError> {
    ...
    if scheme != "stackferry" {
        return Err(AppError::InvalidInput(format!(
            "Invalid scheme: expected 'stackferry', got '{scheme}'"
        )));
    }
