//! Deep link import functionality for StackFerry
//!
//! This module implements the stackferry:// protocol for importing configurations
...
///
/// Represents a parsed stackferry:// URL ready for processing.
