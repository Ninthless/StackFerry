...
use crate::database::{AgentInstance, Database, ResourceOperation, SessionCredentialBinding};
...
fn run_resource_operation(
    ...
    if db_committed {
        quarantine_orphan_directory(original_dir.as_deref(), quarantine_dir.as_deref()).map_err(
            |error| {
