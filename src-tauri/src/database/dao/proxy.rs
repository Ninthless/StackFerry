...
impl Database {
    ...
    pub async fn get_proxy_config_for_app(
        ...
        let result = {
            let conn = lock_conn!(self.conn);
            conn.query_row(
                "SELECT app_type, enabled, auto_failover_enabled, circuit_auto_recovery_enabled,
                ...
                |row| {
                    Ok(AppProxyConfig {
                        ...
                        circuit_auto_recovery_enabled: row.get::<_, i32>(3)? != 0,
        ...
        match result {
            ...
            Err(rusqlite::Error::QueryReturnedNoRows) => {
                ...
                Ok(AppProxyConfig {
                    ...
                    circuit_auto_recovery_enabled: true,
                    max_retries: 3,
    ...
    pub async fn update_proxy_config_for_app(
        ...
        conn.execute(
            "UPDATE proxy_config SET
                ...
                circuit_auto_recovery_enabled = ?4,
                max_retries = ?5,
            ...
            rusqlite::params![
                ...
                if config.circuit_auto_recovery_enabled {
                    1
                } else {
                    0
                },
