...
import { skillsApi, type MigrationResult } from "@/platform/tauri/api/skills";
import type { SkillStorageLocation } from "@/shared/contracts";
  ...
  return (
    <section className="space-y-2">
      ...
      <div className="inline-flex gap-1 rounded-md border border-border-default bg-background p-1">
        <StorageButton
          active={value === "stack_ferry"}
          disabled={isMigrating}
          onClick={() => handleSelect("stack_ferry")}
        >
          {t("settings.skillStorage.stackFerry")}
        </StorageButton>
        <StorageButton
      ...
      <p className="text-xs text-muted-foreground">
        {value === "unified"
          ...
          : t("settings.skillStorage.stackFerryHint")}
      </p>
