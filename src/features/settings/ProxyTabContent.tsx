...
import { AutoFailoverConfigPanel } from "@/features/proxy";
import { FailoverQueueManager } from "@/features/proxy";
import { RectifierConfigPanel } from "@/features/settings/RectifierConfigPanel";
import { GlobalProxySettings } from "@/features/settings/GlobalProxySettings";
import { ConfirmDialog } from "@/shared/ui/ConfirmDialog";
import { ToggleRow } from "@/shared/ui/toggle-row";
import { useProxyStatus } from "@/features/proxy";
          ...
          <AccordionContent className="px-6 pb-6 pt-4 border-t border-border/50">
            <div className="space-y-6">
              ...
              <Tabs defaultValue="claude" className="w-full">
                <TabsList layout="equal" className="w-full">
