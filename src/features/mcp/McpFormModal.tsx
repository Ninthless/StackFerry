...
import { McpServer, McpServerSpec } from "@/shared/contracts";
import {
  mcpPresets,
  getMcpPresetWithDescription,
} from "@/features/mcp/config/mcpPresets";
import McpWizardModal from "./McpWizardModal";
import {
  extractErrorMessage,
  translateMcpBackendError,
} from "@/shared/lib/errorUtils";
import {
  tomlToMcpServer,
  extractIdFromToml,
  mcpServerToToml,
} from "@/shared/lib/tomlUtils";
import { normalizeTomlText } from "@/shared/lib/textNormalization";
import { parseSmartMcpJson } from "@/shared/lib/formatters";
import { useMcpValidation } from "./useMcpValidation";
import { useUpsertMcpServer } from "@/features/mcp/model/useMcp";
    ...
    <>
      ...
      >
        <div className="flex flex-col h-full gap-6">
          <div className="flex-shrink-0 space-y-6 rounded-md border border-border bg-card p-6">
            {!isEditing && (
              <div>
          ...
          <div className="flex min-h-0 flex-1 flex-col rounded-md border border-border bg-card p-6">
