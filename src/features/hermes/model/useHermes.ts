...
import type { HermesMemoryKind } from "@/shared/contracts";
...
export const hermesKeys = {
  all: ["hermes"] as const,
  liveProviderIds: hermesProviderKeys.liveProviderIds,
  modelConfig: hermesProviderKeys.modelConfig,
  memory: (kind: HermesMemoryKind) => ["hermes", "memory", kind] as const,
  memoryLimits: ["hermes", "memoryLimits"] as const,
};

export { invalidateHermesProviderCaches };
