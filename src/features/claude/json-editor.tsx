...
import { tomlEditorDarkTheme } from "@/features/providers/toml-editor-theme"

const jsonLanguage = StreamLanguage.define(json)
const editorExtensions = [jsonLanguage, EditorView.lineWrapping]
...
export function JsonEditor({ id, value, invalid, describedBy, onChange }: Props) {
