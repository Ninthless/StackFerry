...
} from "@/platform/tauri/api/copilot";
import { useSettingsQuery } from "@/features/providers";
...
import { parseGrokBuildConfig } from "@/features/providers";
...
import { TEMPLATE_TYPES, PROVIDER_TYPES } from "@/features/providers";
import {
                  ...
                  <div>
                    ...
                    <p className="text-xs text-muted-foreground mt-1.5">
                      ...
                      <button
                        ...
                        className="inline-flex items-center gap-1 break-all align-baseline text-muted-foreground underline-offset-2 transition-colors hover:text-foreground hover:underline"
                      >
