...
import { providersApi, settingsApi, type AppId } from "@/platform/tauri/api";
...
import {
  providerPresets,
  type ProviderPreset,
} from "@/features/providers/config/claudeProviderPresets";
import {
  codexProviderPresets,
  type CodexProviderPreset,
} from "@/features/providers/config/codexProviderPresets";
import {
  geminiProviderPresets,
  type GeminiProviderPreset,
} from "@/features/providers/config/geminiProviderPresets";
import {
...
} from "@/features/providers/config/hermesProviderPresets";
import { OpenCodeFormFields } from "./OpenCodeFormFields";
import { OpenClawFormFields } from "./OpenClawFormFields";
import { HermesFormFields } from "./HermesFormFields";
import type { UniversalProviderPreset } from "@/features/providers/internal";
import {
  applyTemplateValues,
  hasApiKeyField,
...
import { isNonNegativeDecimalString } from "@/shared/contracts/usage";
...
import { parseOmoOtherFieldsObject } from "@/shared/contracts/omo";
import {
...
import { useSettingsQuery } from "@/features/providers/internal";
import {
...
import { useOpenClawLiveProviderIds } from "@/features/openclaw";
import { useHermesLiveProviderIds } from "@/features/hermes";
import {
  ProviderFormSection,
  ...
  const performSubmit = async (
    ...
    if (!isEditMode && draftCustomEndpoints.length > 0) {
      const customEndpointsToSave: Record<
        string,
        import("@/shared/contracts").CustomEndpoint
      > = draftCustomEndpoints.reduce(
        ...
        {} as Record<string, import("@/shared/contracts").CustomEndpoint>,
      );
