...
import { injectCodingPlanUsageScript } from "@/features/providers/internal";
import {
...
import { openclawProviderKeys } from "./providerCache";
import {
  extractCodexWireApi,
...
import { isOAuthProviderType } from "@/features/providers/internal";
        ...
        if (!proxyRequiredReason) {
          ...
          if (activeApp === "codex") {
            ...
            if (provider.meta?.claudeDesktopMode === "proxy") {
              ...
              defaultMessage =
                "切换成功，请保持 StackFerry 运行，并重启 Claude Desktop 后生效";
            } else {
