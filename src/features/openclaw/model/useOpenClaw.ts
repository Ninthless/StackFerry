...
import { openclawApi } from "@/platform/tauri/api/openclaw";
...
import { openclawProviderKeys } from "@/features/providers";
...
export const openclawKeys = {
  ...
  liveProviderIds: openclawProviderKeys.liveProviderIds,
  defaultModel: openclawProviderKeys.defaultModel,
  env: ["openclaw", "env"] as const,
  tools: ["openclaw", "tools"] as const,
  agentsDefaults: ["openclaw", "agentsDefaults"] as const,
  health: openclawProviderKeys.health,
};
