...
const api: StackferryApi = {
  ...
  detectLegacyImport: () => ipcRenderer.invoke(IpcChannel.detectLegacyImport),
  chooseLegacyImport: () => ipcRenderer.invoke(IpcChannel.chooseLegacyImport),
  importLegacyProviders: (dbPath) => ipcRenderer.invoke(IpcChannel.importLegacyProviders, dbPath),
